...
1. Have **one person** in your group create a new team by `clicking here <https://classroom.github.com/a/zrKYTs3F>`_ and going to the ``OR Create a new team`` box at the bottom of the page. The team name should include the last names of all your group members. For example, if Xia and Smith are working together, the team name should be something like “XiaSmith”.
...
.. image:: FileView.png
  :alt: Picture of VS Code
  :width: 800
  :height: 450
  :align: center

|
   The tab is usually at the bottom may be near the ``Terminal`` tab

* The Red Xs indicate test cases that failed. You can click on them to be taken to the code that failed.
