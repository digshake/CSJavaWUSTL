...
1. Have **one person** in your group create a new team by clicking `here <https://classroom.github.com/a/_berWX0c>`_ and going to the `OR Create a new team` box at the bottom of the page.
